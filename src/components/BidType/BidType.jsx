    ...
    <>
      <div>
        <div className="flex-row">
          ...
          <div className="flex-column">
              <div className="flex-row">
                <Link to="/" className="bidTypesListBtn btn btn-primary mb-1">
                  <svg
              ...
              <div className="flex-row">
                <Link to="/" className="bidTypesListBtn btn btn-info mb-1 ">
                  Bid Periods &#187;
                </Link>
              </div>
              <div className="flex-row">
              ...
              <div className="flex-row">
                <Link to="/" className="bidTypesListBtn btn btn-danger">
                  <span className="whiteX">&#128941; </span>Delete
                </Link>
            </div>
          </div>
        </div>
